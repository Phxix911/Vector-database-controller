...
add wave -noupdate -radix hexadecimal /toplevel_tb/top/p/bus_data
add wave -noupdate -height 40 /toplevel_tb/clk
add wave -noupdate -height 40 -radix hexadecimal /toplevel_tb/top/p/CurrBusDataOut
add wave -noupdate -height 40 -radix hexadecimal /toplevel_tb/top/p/NextBusDataOut
add wave -noupdate -height 40 -radix hexadecimal -childformat {{{/toplevel_tb/top/p/CurrBusAddr[7]} -radix hexadecimal} {{/toplevel_tb/top/p/CurrBusAddr[6]} -radix hexadecimal} {{/toplevel_tb/top/p/CurrBusAddr[5]} -radix hexadecimal} {{/toplevel_tb/top/p/CurrBusAddr[4]} -radix hexadecimal} {{/toplevel_tb/top/p/CurrBusAddr[3]} -radix hexadecimal} {{/toplevel_tb/top/p/CurrBusAddr[2]} -radix hexadecimal} {{/toplevel_tb/top/p/CurrBusAddr[1]} -radix hexadecimal} {{/toplevel_tb/top/p/CurrBusAddr[0]} -radix hexadecimal}} -subitemconfig {{/toplevel_tb/top/p/CurrBusAddr[7]} {-radix hexadecimal} {/toplevel_tb/top/p/CurrBusAddr[6]} {-radix hexadecimal} {/toplevel_tb/top/p/CurrBusAddr[5]} {-radix hexadecimal} {/toplevel_tb/top/p/CurrBusAddr[4]} {-radix hexadecimal} {/toplevel_tb/top/p/CurrBusAddr[3]} {-radix hexadecimal} {/toplevel_tb/top/p/CurrBusAddr[2]} {-radix hexadecimal} {/toplevel_tb/top/p/CurrBusAddr[1]} {-radix hexadecimal} {/toplevel_tb/top/p/CurrBusAddr[0]} {-radix hexadecimal}} /toplevel_tb/top/p/CurrBusAddr
add wave -noupdate -height 40 -radix hexadecimal /toplevel_tb/top/p/NextBusAddr
add wave -noupdate -height 40 -radix hexadecimal /toplevel_tb/top/p/CurrRegA
add wave -noupdate -height 40 -radix hexadecimal /toplevel_tb/top/p/CurrRegB
add wave -noupdate -height 40 -radix hexadecimal /toplevel_tb/top/p/temporeg
add wave -noupdate -height 40 -radix hexadecimal /toplevel_tb/top/p/CurrState
add wave -noupdate -height 40 -radix hexadecimal /toplevel_tb/top/p/NextState
...
add wave -noupdate -childformat {{{/toplevel_tb/top/stack3/memory[1]} -radix hexadecimal} {{/toplevel_tb/top/stack3/memory[0]} -radix hexadecimal}} -subitemconfig {{/toplevel_tb/top/stack3/memory[1]} {-height 15 -radix hexadecimal} {/toplevel_tb/top/stack3/memory[0]} {-height 15 -radix hexadecimal}} /toplevel_tb/top/stack3/memory
...
WaveRestoreCursors {{Cursor 1} {378715 ps} 0} {{Cursor 2} {31765572336 ps} 0} {{Cursor 3} {39583230000 ps} 0} {{Cursor 4} {511839 ps} 0}
...
update
WaveRestoreZoom {378715 ps} {511839 ps}
